...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    const [coupon, getCoupon] = (0, import_react17.useState)("");
    const applyDiscountCodeChange = useApplyDiscountCodeChange();
    const [appliedCodes, setAppliedCodes] = (0, import_react17.useState)([]);
    const { shop } = useApi();
    ...
    const applyDiscount = () => __async(this, null, function* () {
      try {
        yield fetch("https://farzipromoshopify.farziengineer.co/discount", {
          method: "POST",
          headers: {
    ...
    const removeDiscount = (coupon2) => __async(this, null, function* () {
      try {
        yield applyDiscountCodeChange({
          type: "removeDiscountCode",
          code: coupon2
        });
        setAppliedCodes(appliedCodes.filter((appliedCode) => appliedCode !== coupon2));
      } catch (err) {
        console.error(err);
      }
    });
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { border: "base", padding: "base", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: "tight", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: "Apply Discount Code" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: "tight", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Grid2, { columns: ["70%", "fill", "auto"], spacing: "tight", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { kind: "primary", appearance: "monochrome", onPress: () => applyDiscount(), children: "Apply" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { padding: "tight", children: appliedCodes.map((coupon2, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Banner2,
        {
          status: "",
          title: coupon2,
          onDismiss: () => removeDiscount(coupon2)
        },
        index
      )) })
    ] }) });
